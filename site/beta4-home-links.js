(() => {
  ...
  function mount() {
    ...
    const instagram = cfg.instagramUrl || "https://www.instagram.com/baliclubminsk/";
    const map = cfg.yandexMapUrl || "https://yandex.by/maps/org/bali_night_club/104137822369/";
    const card = document.createElement("section");
    card.className = "card";
    card.id = "clubLinks";
    card.innerHTML = `<div class="card-head"><h3>Связаться с BALI</h3></div><div class="club-links"><a href="${instagram}" data-open-link><i>◎</i><span><strong>Instagram</strong><small>Новости и атмосфера</small></span></a><a href="${telegram}" data-telegram-link><i>✈</i><span><strong>Telegram</strong><small>Канал клуба</small></span></a><a href="tel:${phone.replace(/[^+\d]/g, "")}"><i>☎</i><span><strong>Позвонить</strong><small>${phone}</small></span></a><a href="${map}" data-open-link><i>⌖</i><span><strong>Как добраться</strong><small>Яндекс Карты</small></span></a></div>`;
