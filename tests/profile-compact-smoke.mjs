...
assert.ok(html.includes("bali-social-inbox-1"), "Published page must use the social inbox cache version");
...
assert.ok(profile.includes("Входящие приглашения"), "The incoming invitations dialog must exist");
