...
assert.equal(api.BLOCKS.length, 28, "all 28 major visual blocks must be registered");
...
console.log("Validated 28 configurable visual blocks, dimensions, persistence, and resets");
