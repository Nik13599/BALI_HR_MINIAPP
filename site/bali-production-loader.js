(async () => {
  ...
  const optional = async (name, limit = 6000) => {
    try { return await load(name, limit); }
    catch (error) { console.warn("[BALI optional]", error?.message || error); return null; }
  };
  const optionalBatch = names => Promise.allSettled(names.map(name => optional(name)));
  ...
  if (window.BaliHomeDesignCloudReady) {
    await Promise.race([window.BaliHomeDesignCloudReady, new Promise(resolve => setTimeout(resolve, 2500))]);
  }
  ...
  window.dispatchEvent(new CustomEvent("bali:production-ready", { detail: { version, phase: "core" } }));

  const visual = [
    "legacy-nav-final-beta4.js","home-layout-final-beta4.js","beta4-menu-categories.js","beta4-menu-media.js",
    "beta4-layout-map.js","beta4-home-links.js","beta4-profile-booking.js","beta4-loyalty-ui-stable.js",
    "beta4-social-page.js","beta4-profile-v2.js","profile-demographics-beta4.js","bali-bonuses-only-beta4.js",
  ...
  const extras = [
    "user-vip-card-production.js","bali-people-status-sync-beta4.js","social-gifts-production.js",
    "bali-people-open-likes-beta4.js","bali-people-live-event-beta4.js","beta4-reward-icon-view.js",
    "beta4-qr-checkin.js","beta4-ranking-visits.js","bali-people-privacy-beta4.js",
    "bali-people-search-ranking-beta4.js","bali-people-public-cards-beta4.js","bali-people-vip-frame-beta4.js",
    "vip-duration-options-beta4.js","chip-requests-user-beta4.js","legacy-event-attendance-beta4.js"
  ];

  setTimeout(async () => {
    for (const name of visual) await optional(name, 5000);
    window.dispatchEvent(new CustomEvent("bali:production-ready", { detail: { version, phase: "visual" } }));
    await optionalBatch(extras);
  ...
  document.getElementById("baliLoadError").textContent = error?.message || "Ошибка загрузки";
