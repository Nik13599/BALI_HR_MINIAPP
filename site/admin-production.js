(() => {
  ...
  async function api(path, options = {}) {
    if (typeof window.BaliBetaApi === "function") {
      return window.BaliBetaApi(path, options);
    }
  ...
  async function renderAudit() {
    ...
    const auditCsvHref = window.BaliAdminAuditHref || "/api/v1/admin/audit?format=csv&limit=1000";
